...
import { useProject, useUpdateProject, useProjectMembers, useInviteMember, useRemoveMember, useUpdateMemberRole, useDeleteProject } from '@/hooks/use-projects'
        ...
        <div className="container mx-auto py-8 max-w-4xl">
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">Manage project details and members</p>
                </div>
            </div>
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input id="identifier" value={identifier} onChange={(e) => setIdentifier(e.target.value)} maxLength={5} className="uppercase" />
                    </div>
                    <div className="grid gap-2">
        ...
        <Card>
            ...
            <CardContent>
                <div className="space-y-4">
                    {members?.map((member) => (
                        <div key={member.userId} className="flex items-center justify-between p-2 rounded-lg border bg-card hover:bg-accent/50 transition-colors">
                            ...
                            <div className="flex items-center gap-2">
                                <Select
                                    value={member.role}
                                    onValueChange={(val) => updateRole.mutate({ projectId, userId: member.userId, role: val })}
                                >
